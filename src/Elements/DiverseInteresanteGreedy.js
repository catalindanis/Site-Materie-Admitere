...
function DiverseInteresanteGreedy() {
  return (
    <div className="Card">
      ...
      <Description text="-se aplică greedy
-pentru fiecare refill, fac o distanță cât mai mare astfel încât să pot aduce restul sticlelor la acea distanță"></Description>
      <img src={img2} className="mb-2" id="image75"></img>
      <img src={img3} className="mb-2" id="image75"></img>
        <Description text="-cele 2 grile de mai sus sunt 2 grile populare (eprubete, interclasări) care ambele funcționează pe același principiu de greedy
