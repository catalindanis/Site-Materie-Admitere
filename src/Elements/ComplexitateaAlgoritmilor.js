...
function ComplexitateaAlgoritmilor() {
  return (
    <div className="Card">
      ...
      <Description
        text="-suma de pași 1 + 1/2 + 1/3 + 1/4 + ... + 1/n = logn (demonstrație matematică, nu are rost)
...
O(n!) = O(n^n)"
      ...
      <Description
        text="-răspunsurile corecte sunt B și D
-se folosește aproximarea (1 + 1/2 + 1/4 + ...) = 2 => complexitate O(n)"
      ></Description>
      <img src={img4} className="mb-2" id="image75"></img>
      <Description
        text="-răspunsurile corecte sunt A și C
-se folosește aproximarea n! = n^n"
      ></Description>
      <h6 className="mt-4">
